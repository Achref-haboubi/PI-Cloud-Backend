  ...
  private String template(String name, String heading, String body, String accentColor, String badge) {
    ...
    public void sendLowStockAlert(String to, String productName, double stock) {
        ...
        String body = template(
            "Restaurant Manager", // nom (temporaire)
            "Stock faible détecté",
            "Le produit <strong>" + productName + "</strong> a un stock faible.<br><br>" +
    ...
    public void sendOutOfStockAlert(String to, String productName) {
        ...
        String body = template(
            ...
            "Le produit <strong>" + productName + "</strong> est actuellement <strong>en rupture de stock</strong>.<br><br>" +
